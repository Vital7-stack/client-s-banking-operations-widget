...
def sample_transactions() -> List[Dict[str, Any]]:
    """Фикстура с тестовыми транзакциями для фильтрации и сортировки."""
    return [
...
def card_numbers() -> Dict[str, str]:
    """Фикстура с номерами карт для тестирования маскирования."""
    return {
...
def account_numbers() -> Dict[str, str]:
    """Фикстура с номерами счетов для тестирования маскирования."""
    return {
