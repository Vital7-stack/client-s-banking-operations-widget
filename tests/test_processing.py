...
class TestProcessing:
    def test_filter_by_state_executed(self, sample_transactions: List[Dict[str, Any]]) -> None:
        ...
        filtered: List[Dict[str, Any]] = filter_by_state(sample_transactions, "EXECUTED")
    ...
    def test_filter_by_state_not_found(self, sample_transactions: List[Dict[str, Any]]) -> None:
        ...
        filtered: List[Dict[str, Any]] = filter_by_state(sample_transactions, "CANCELLED")
    ...
    def test_sort_by_date(
        ...
        sorted_transactions: List[Dict[str, Any]] = sort_by_date(sample_transactions, order=sort_order)
    ...
    def test_sort_by_same_dates(self) -> None:
        ...
        sorted_transactions: List[Dict[str, Any]] = sort_by_date(transactions, order="asc")
